...
You can also save your searches for quick access later by modifying the variable =consult-mu-saved-searches=. This is a list of mu4e queries (i.e. strings) that gets added to future-history when you run consult-mu or
