...
#+CAPTION[highlight is off]: When Message is viewed highlight overlays are turned off.
#+attr_org: :width 800px :height nilpx
#+attr_latex: :width 800px :height nilpx
#+attr_html: :width 800px :height nilpx
...
#+CAPTION[highlight is on]: higlhights are turned back on by =M-x consult-mu-overlays-toggle=.
