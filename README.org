...
For example, the string ="%d13%s50%f17"= would make a header containing =13= characters for =date=, =50= characters for =subject=, and =20= characters for =from= field, making headers that looks like this:
...
#+attr_latex: :width 800px :height nilpx
#+attr_html: :width 800px :height nilpx
[[https://github.com/armindarvish/consult-mu/blob/screenshots/screenshots/highlight-matches-minibuffer.png]]
...
#+attr_latex: :width 800px :height nilpx
#+attr_html: :width 800px :height nilpx
[[https://github.com/armindarvish/consult-mu/blob/screenshots/screenshots/highlight-matches-view.png]]
